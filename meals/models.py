...
class Meal(models.Model):
    ...
    status = models.CharField(max_length=10, choices=MealStatus.choices, default=MealStatus.PENDING)
    prev_status = models.CharField(max_length=10, null=True, choices=MealStatus.choices, default=None)
